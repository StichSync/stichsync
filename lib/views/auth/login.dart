        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              SizedBox(width: height * 0.4, height: height * 0.4, child: ClipRRect(borderRadius: BorderRadius.circular(300), child: const Image(image: NetworkImage("https://media.discordapp.net/attachments/864791833309085707/1214270526206255194/image.png?ex=65f8808d&is=65e60b8d&hm=b861929d04eebff70a738227bab4d4cf5ef6b030214e930bf7e392295d4973ae&=&format=webp&quality=lossless")))),
              ...
              Align(alignment: Alignment.centerRight, child: RichText(text: TextSpan(text: "Forgor💀 password?", style: const TextStyle(color: Colors.orange), recognizer: TapGestureRecognizer()..onTap = () {forgotPassword();}),)),
              SsTextButton(text: "Log in", bgColor: Colors.orange, textColor: Colors.white, onPressed: () {loginValidator();},),
              Column(children: [
                const Text("Don't have an account yet?", style: TextStyle(color: Color.fromARGB(255, 82, 82, 82))),
                RichText(text: TextSpan(text: "Sign Up", style: const TextStyle(color: Colors.orange), recognizer: TapGestureRecognizer()..onTap = () {Navigator.pushNamed(context, "/register");}),)
              ]),
              Padding(
