        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              SsTextInput(key: keyUsername, size: Size(width * 0.8, height * 0.07), text: "Username", icon: Icons.person),
              ...
              SsTextInput(key: keyRPass, isPassword: true, size: Size(width * 0.8, height * 0.07), text: "Repeat password", icon: Icons.lock),
              SsTextButton(text: "Register", bgColor: Colors.orange, textColor: Colors.white, onPressed: () { registerValidator(); },),
              Padding(
